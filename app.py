                ...
                columns=[
                    CarouselColumn(
                        ...
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/fs1:%20Halo%20Salam%20Kenal'
                            )
                        ]
                    ),
                    CarouselColumn(
                        ...
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/fs2:%20Halo%20Salam%20Kenal'
                            )
                        ]
                    ),
                    CarouselColumn(
                        ...
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/graffiti:%20Halo%20Salam%20Kenal'
                            )
                        ]
                    ),
                    CarouselColumn(
                        ...
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/light:%20TRIO%20PEKOK%20BOTS'
                            )
                        ]
                    ),
                    CarouselColumn(
                        ...
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/street:%20TRIO%20PEKOK%20BOTS'
                            )
                        ]
                    ),
                    CarouselColumn(
                        ...
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/cookies:%20TRIO%20PEKOK%20BOTS'
                            )
                        ]
                    ),
                    CarouselColumn(
                        ...
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/sletters:%20TRIO%20PEKOK%20BOTS'
                            )
                        ]
                    ),
                    CarouselColumn(
    ...
    if event.message.text == "/app":
        ...
        message = TemplateSendMessage(
            ...
            template=CarouselTemplate(
                columns=[
                    CarouselColumn(
                        thumbnail_image_url='https://obs.line-apps.com/' + line_bot_api.get_profile(event.source.user_id).picture_url,
