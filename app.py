...
#-------------{ Credit by @Basyir? }-------------#
    ...
    elif (text == '/token') or (text == 'tokenlist'):
        message = TemplateSendMessage(
            alt_text='Enjoy Generate Your Token',
            template=CarouselTemplate(
                columns=[
                    CarouselColumn(
                        thumbnail_image_url='https://i.ibb.co/Tr1mjYH/1545946474474.jpg',
                        title='TOKEN CHROMEOS',
                        text='Enjoy Your Generate Token Bots',
                        align= 'center',
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
