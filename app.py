...
#-------------{ REMAKE }-------------#
    ...
    if text == '/tiktok':
        ...
        bsyr = ('「 0.001705247497558594 」 second','「 0.002705247497558594 」 second','「 0.001703447497558594 」 second','「 0.001105247497558594 」 second','「 0.003705247497558544 」 second','「 0.0027052474975585578 」 second')
        triopekok = random.choice(bsyr)
        message = TextSendMessage(text=triopekok)
        line_bot_api.reply_message(event.reply_token, message)
                ...
                columns=[
                    ...
                    CarouselColumn(
                        ...
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/gettimeline'
                            )
                        ]
                    ),
                    CarouselColumn(
