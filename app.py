            ...
            template=CarouselTemplate(
                columns=[
                    CarouselColumn(
                        ...
                        title='YOUTUBE',
                        text='Download and listen to songs casually',
                        align= 'center',
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/youtube'
                            )
                        ]
                    ),
                    CarouselColumn(
                        ...
                        title='ARTI NAMAMU',
                        text='Cari Arti Dari Namamu',
                        align= 'center',
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/artinama'
                            )
                        ]
                    ),
                    CarouselColumn(
                        ...
                        title='SEARCH IDLINE',
                        text='Cari Id Linemu Dengan Mudah',
                        align= 'center',
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/idline'
                            )
                        ]
                    ),
                    CarouselColumn(
                        ...
                        title='RANDOM TIKTOK',
                        text='Enjoy Show Video Tiktok',
                        align= 'center',
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/tiktok'
                            )
                        ]
                    ),
                    CarouselColumn(
                        ...
                        title='IMAGE TEXT',
                        text='Edit Nama Menggunakan Gambar Keren',
                        align= 'center',
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/imagetext'
                            )
                        ]
                    ),
                    CarouselColumn(
                        thumbnail_image_url='https://media.giphy.com/media/okWCAjMp0pInC/giphy.gif',
                        title='DOWNLOAD SMULE',
                        text='Download and listen to songs casually',
                        align= 'center',
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/smuledownloader'
                            )
                        ]
                    ),
                    CarouselColumn(
                        thumbnail_image_url='https://media.giphy.com/media/Elie14Y5mbi9y/giphy.gif',
                        title='TRANSLATE',
                        text='Translate Bahasa Secara Mudah',
                        align= 'center',
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/translate'
                            )
                        ]
                    ),
                    CarouselColumn(
                        thumbnail_image_url='https://media.giphy.com/media/Xhwv0kw43N5MA/giphy.gif',
                        title='INFO BMKG',
                        text='Ketahui Info Gempa Terkini',
                        align= 'center',
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                    ...
                    CarouselColumn(
                        ...
                        text='Mendownload Timeline Line Massanger',
                        align= 'center',
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/downloadtl'
                            )
                        ]
                    ),
                    CarouselColumn(
                        ...
                        text='Mendownload gambar Google Dengan Mudah',
                        align= 'center',
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/goimage'
                            )
                        ]
                    ),
                    CarouselColumn(
                        ...
                        title='ZODIAC',
                        text='Cek Info Zodiakmu Hari Ini',
                        align= 'center',
                        actions=[
                            URITemplateAction(
                                label='>Tap the Button<',
                                uri='line://app/1636361179-N9dnRpYg?type=fotext&text=/zodiac'
                            )
                        ]
                    ),
                ]
...
#-------------{ Credit by @Basyir? }-------------#
        ...
        message = TemplateSendMessage(
            ...
            template=CarouselTemplate(
                columns=[
                    CarouselColumn(
                        thumbnail_image_url='https://stickershop.line-scdn.net/stickershop/v1/sticker/12842276/IOS/sticker_animation@2x.png',
